...
![Jupyter Terminal](../static/CUPiD/Jupyter_Terminal.png)
...
![A list of 11 directories; cupid, environments, examples, and nblibrary are circled](../static/CUPiD/dir_structure_toplevel.png)
...
![A list of 4 directories: additional_metrics, external_diag_packages, key_metrics, and regional_ocean](../static/CUPiD/dir_structure_examples.png)
...
![A list of 7 directories: atm, glc, ice, infrastructure, lnd, ocn, rof](../static/CUPiD/dir_structure_nblibrary.png)

And then each subdirectory contains one or more notebooks.
For example, the `ocn/` directory has:

![A list of 6 files: Global_Ocean_Surface.ipynb,       Regional_Ocean_Atmospheric_Forcing.ipynb,  Regional_Ocean_Report_Card.ipynb, Regional_Ocean_Animations.ipynb, Regional_Ocean_OBC.ipynb, regional_utils.py](../static/CUPiD/dir_structure_nblibrary_ocn.png)
