...
1. Make sure you can log in to the jupyter notebook portal `OnDemand`: [https://ondemand.hpc.ucar.edu/] with your NCAR account. You should have gotten an email with the setup steps. We are going to setup the tools on your account on the NCAR computer.
