...
on a login node. Get a starter PBS submission script the same way:
...
| Command | Purpose |
|---|---|
| `crocodash template` | Write a starter config (`.yaml`), notebook (`.ipynb`), script (`.py`), or PBS submission script (`.pbs`) |
